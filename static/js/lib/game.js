...
export class Game {
    ...
    increaseDifficulty() {
        ...
        if(this.timePassed === 30) {
            ...
            this.displayNotification("Eles estão acelerando!");
            ...
            this.displayNotification("Eles estão acelerando novamente!!");
            ...
            // After speed update, enable interval again
            enemies.enemiesShootingInterval = setInterval(enemies.shoot.bind(enemies), enemies.shootingSpeed);
            this.displayNotification("Oh meu Deus, vamos conseguir?!");
            ...
            this.displayNotification("Eles são muito rápidos!!!");
        }
    };
    ...
    timer(secondsLeft){
        ...
        this.countdown = setInterval(() =>{
            ...
            if(this.secondsLeft === 10) {
                ...
                this.displayNotification("Você não tem muito tempo sobrando!");
    ...
    addPlaytime() {
        ...
        this.displayNotification("Adicionado tempo de jogo!");
    };
    ...
    newScore(finalScore) {
        ...
        if(finalScore > this.highscore) {
            scoreText.innerHTML = `<h2 class="newHighscore-notification">NOVO RECORDE !!! </h2>`;
        } else {
            scoreText.innerHTML = `<h2>NADA MAL</h2>`;
        }
    ...
    newHighscore() {
        ...
        emptyWarningText.textContent = "NOVO RECORDE !!!";
    ...
    endgame(secondsLeft){
        ...
        if(player.hp === 0){
            ...
            message.textContent = "Pelo menos tentou...";
        }

        // If the time is up
        if(secondsLeft <= 0) {
            message.textContent = "Acabou o tempo !";
        }
