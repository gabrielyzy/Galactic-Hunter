...
export class Player {
        ...
        if(game.isStarted) {
            ...
            || this.map[this.useBooster] && this.d === "RIGHT"){
                ...
                if(this.booster <= 0) {
                    ...
                    emptyWarningText.textContent = "BOOSTER VAZIO!";
    ...
    overheating() {
        ...
        if(this.overheat === 100) {
            ...
            emptyWarningText.textContent = "SUPERAQUECIMENTO!";
            emptyWarningText.classList.add("emptyWarning-textActive");
    ...
    restoreShipHP() {
        ...
        if(this.hp === 100) {
            ...
            this.hp = this.hp + 20;
            this.healthText.textContent = this.hp+"%";
            game.displayNotification("Saúde restaurada!");
        }
    };
    ...
    restoreShield() {
        if(this.shield === 100) {
            ...
            this.shieldText.textContent = this.shield+"%";
            game.displayNotification("Escudo restaurado!");
        }
    };
